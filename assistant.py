...
def run():
    print("Listening...")
    query = listen()
    response = openai.Completion.create(model="text-davinci-003", prompt="You are a general intelligence AI. Respond to this query: " + query, temperature=0, max_tokens=3000)
